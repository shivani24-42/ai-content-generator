export default [
  {
    ...
    aiPrompt:
      "Generate 5 blog topic ideas in bullet points based on the given niche and outline. Return the result in rich text editor format. Do not use bold text formatting.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate top 5 Blog Topic Ideas in bullet point only, (no Description) based on niche in rich text editor format. Do not use bold text formatting.",
    form: [
      {
  ...
  },
  {
    ...
    aiPrompt:
      "Give me Best SEO optimized high ranked 5 title ideas bullet wise only bases on keywords and outline and give me result in HTML tags format. Do not use bold text formatting.",
    form: [
      {
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a 4–5 line YouTube description with emojis based on the topic and outline. Return it in rich text editor format.",
    form: [
      {
  ...
  },
  {
    ...
    aiPrompt:
      "Generate 10 Youtube tags in bullet point based on title and outline in rich text editor format. Do not use bold text formatting.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate 15 Instagram hash tag depends on a given keywords and give output in  in rich text editor format. Do not use bold text formatting.",
    form: [
      {
  ...
  },
  {
    ...
    slug: "explain-code",
    aiPrompt:
      "Generate code based on the given description. Return it in rich text editor format inside a code block.",
    form: [
      {
