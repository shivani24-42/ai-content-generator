...
async function History() {
  ...
  return (
    <div className="m-8 card p-8">
      <h2 className="font-extrabold text-3xl tracking-tight text-slate-800">History</h2>
      <p className="text-slate-500 mt-1">
        Search your previously generated AI content history
      </p>
      <div className="grid grid-cols-7 font-bold bg-slate-100 border border-slate-200 rounded-lg mt-6 py-4 px-4 text-slate-600 text-sm tracking-wide">
      ...
      {HistoryList.length > 0 ? (
        ...
        <p className="text-center mt-5 text-slate-500">No history found for your account.</p>
      )}
    </div>
  );
}
